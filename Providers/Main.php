...
class Main extends Provider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'efi');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'efi');
    }
    ...
    public function loadViewComposers()
    {
        View::composer(
            ...
            function ($view) {
                $field_validations = setting('efi.field_validations', '0');

                if($field_validations === '1') {
                    $view->getFactory()->startPrepend(
                        'scripts_end',
                        view('efi::admin._script')
                    );
                }
            }
        );
